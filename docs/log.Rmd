...
multiTable("../data/testdata.confidential/QXTR_810-Exoom_v3/run01/qc/statistics/data.insert_size_metrics", "#")
```
```{r}
...
```{r}
insertSizes <- read.table("../data/insertSizes.table", header = TRUE, sep = "\t", fill = TRUE)
```
